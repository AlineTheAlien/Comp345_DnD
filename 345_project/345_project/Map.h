...
//! performace than a 2D array. In each tile of the map, there could be an enemy, a chest, a wall,
...
private:
	...
	int mapX;
	//! Pointer to a one dimensional dynamic array of characters that represents the map
	char *map;
